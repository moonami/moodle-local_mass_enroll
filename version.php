...
$plugin->version   = 2015092403;            // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release   = '2.7.0 (Build 2015092403)';// Required for registering to Moodle's database of plugins.
